...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_2018_CHS_sys/workdir_Zprime_PreSelec_2018_TimePtEta_up/ 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_common_TimePtEta_up
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_common_TimePtEta_up
