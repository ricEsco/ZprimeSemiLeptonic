...
namespace uhh2 {
  ...
  public:
    ...
    std::string hist_names_cos_theta1k_antiLep[100];
    std::string hist_names_cos_theta1r_antiLep[100];
    std::string hist_names_cos_theta1n_antiLep[100];
    std::string hist_names_cos_theta1kStar_antiLep[100];
    std::string hist_names_cos_theta1rStar_antiLep[100];
    std::string hist_names_cos_theta2k_Lep[100];
    std::string hist_names_cos_theta2r_Lep[100];
    std::string hist_names_cos_theta2n_Lep[100];
    std::string hist_names_cos_theta2kStar_Lep[100];
    std::string hist_names_cos_theta2rStar_Lep[100];
    std::string hist_names_cos_theta1k[100];
    std::string hist_names_cos_theta1r[100];
    std::string hist_names_cos_theta1n[100];
    std::string hist_names_cos_theta1kStar[100];
    std::string hist_names_cos_theta1rStar[100];
    std::string hist_names_cos_theta2k[100];
    std::string hist_names_cos_theta2r[100];
    std::string hist_names_cos_theta2n[100];
