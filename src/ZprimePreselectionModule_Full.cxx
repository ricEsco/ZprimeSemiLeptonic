...
class ZprimePreselectionModule_Full : public ModuleBASE {

public:
  explicit ZprimePreselectionModule_Full(uhh2::Context&);
...
void ZprimePreselectionModule_Full::book_histograms(uhh2::Context& ctx, vector<string> tags){
...
void ZprimePreselectionModule_Full::fill_histograms(uhh2::Event& event, string tag){
  string mytag = tag+"_General";
...
void ZprimePreselectionModule_Full::init_JEC_JLC(uhh2::Context& ctx){
  ...
  if(is2016v2 || is2016v3){
    cout<<"ZprimePreselectionModule_Full uses JEC for 2016 data/MC"<<endl;
  ...
  if(is2017){
    cout<<"ZprimePreselectionModule_Full uses JEC for 2017 data/MC"<<endl;
  ...
  if(is2018){
    cout<<"ZprimePreselectionModule_Full uses JEC for 2018 data/MC"<<endl;
...
ZprimePreselectionModule_Full::ZprimePreselectionModule_Full(uhh2::Context& ctx){
...
bool ZprimePreselectionModule_Full::process(uhh2::Event& event){
...
/*
  ...
  if(event.isRealData){
    ...
    if(apply_A+apply_B+apply_C+apply_D+apply_E+apply_F+apply_G+apply_H != 1) throw std::runtime_error("In ZprimePreselectionModule_Full.cxx: Sum of apply_* when applying JECs is not == 1. Fix this.");
...
UHH2_REGISTER_ANALYSIS_MODULE(ZprimePreselectionModule_Full)
