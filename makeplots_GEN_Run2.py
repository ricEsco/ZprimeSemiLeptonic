...
if channel=="ele":
    ...
    plotDirectory = "/data/dust/user/ricardo/SpinCorrAnalysis_Gen/plots/Run2/"
    _fileDir =      "/data/dust/user/ricardo/SpinCorrAnalysis_Gen/muon/workdir_SpinCorr_Gen_UL_Run2_muon"
