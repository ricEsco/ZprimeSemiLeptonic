...
if channel=="ele":
    ...
    plotDirectory = "/nfs/dust/cms/user/ricardo/SpinCorrAnalysis_Gen/plots/Run2/"
    _fileDir =      "/nfs/dust/cms/user/ricardo/SpinCorrAnalysis_Gen/muon/workdir_SpinCorr_Gen_UL_Run2_muon"
...
sample_names = ["TTToSemiLeptonic_Run2_0", "TTToSemiLeptonic_Run2_1", "TTToSemiLeptonic_Run2_2", "TTToSemiLeptonic_Run2_3", "TTToSemiLeptonic_Run2_4", "TTToSemiLeptonic_Run2_5"]
...
stackList = {"TTToSemiLeptonic_Run2_0":[kRed], "TTToSemiLeptonic_Run2_1":[kRed], "TTToSemiLeptonic_Run2_2":[kRed], "TTToSemiLeptonic_Run2_3":[kRed], "TTToSemiLeptonic_Run2_4":[kRed], "TTToSemiLeptonic_Run2_5":[kRed]}
...
for histName in histograms:
    ...
    for sample in sample_names:
        ...
        if (sample=="TTToSemiLeptonic_Run2_1" or sample=="TTToSemiLeptonic_Run2_2" or sample=="TTToSemiLeptonic_Run2_3" or sample=="TTToSemiLeptonic_Run2_4" or sample=="TTToSemiLeptonic_Run2_5"):
            hist[histName][sample].SetYTitle(histograms[histName][1])      
            print "Filling with", sample
            stack[histName].Add(hist[histName][sample])
            continue
        legendR[histName].AddEntry(hist[histName][sample],"TTToSemiLeptonic",'f')
        hist[histName][sample].SetYTitle(histograms[histName][1])    
        print "Filling with", sample
        stack[histName].Add(hist[histName][sample])   
    ...
    CMS_lumi.CMS_lumi(pad1, 2, 11) # parameters are: (pad, Year, iPosX, extraLumiText = "") <----------- DONT FORGET TO CHANGE THE YEAR TO GET THE RIGHT LUMI (16=2016, 17=2017, 18=2018, 2=ALL of Run 2)
